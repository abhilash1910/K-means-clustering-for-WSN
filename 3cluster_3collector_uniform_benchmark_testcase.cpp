...
cout<<"Velocity of the third collector"<<endl;
int velocity3;
cin>>velocity3;
cout<<velocity3<<"cm/s"<<endl;
cout<<"Distance between sink and cluster3"<<endl;
int distance3;
cin>>distance3;
cout<<distance3<<"cm"<<endl;
int time3=distance3/velocity3;
cout<<"Time taken for collector 3 to go to cluster3"<<endl;
cout<<time3<<"s"<<endl;
...
totalenergy2-= (Eelec + energyamplitude*r111*r111 + energyamplitude*r211*r211 + energyamplitude*r311*r311 + energyamplitude*r411*r411);
cout<<"Energy loss in ith iteration"<<"J"<<endl;
cout<<abs(totalenergy2)<<endl;
